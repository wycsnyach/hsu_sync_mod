<?php
	...
	if($project=="cin"){
		$server_token=$init_params['cin']['server_token'];
		$local_token=$init_params['cin']['local_token'];
	}else if($project=="clinician"){
		$server_token=$init_params['clinician']['server_token'];
		$local_token=$init_params['clinician']['local_token'];
	}
